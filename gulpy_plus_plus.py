...
if __name__ == '__main__':
    ...
    parser.add_option("-d", "--diagnostic", default=True,
                      help="Diagnostic mode. Should insertions be rolled back?"
    )
    parser.add_option("-s", "--sample-size", dest="sample_size", default=100,
    ...
    for fname in filenames:
        ...
        with transaction_to_rollback(options.connection_string, options.diagnostic) as sesh:
